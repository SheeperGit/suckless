...
static const char *const autostart[] = {
	...
	"dunst", NULL,
	"sh", "-c", "discord &", NULL,
	"sh", "-c", "sleep 20 ; firefox &", NULL,  
	"sh", "-c", "sleep 12 ; kill -44 $(pidof dwmblocks)", NULL,	/* Refresh volume block at startup. Ensures correct startup volume display */
	NULL /* terminate */
};
...
static const char *lnchcmd[]  = { "launch", NULL };
static const char *forgcmd[]  = { "forge", NULL };
static const char *bgcmd[]    = { "bg-set", NULL };
static const char *batcmd[]   = { "bat", NULL };
...
static const Key keys[] = {
  ...
  KEYPADTAGKEYS(                  XK_KP_End,                 0) /********************************************/
	...
	{ ShiftMask,			           XK_Page_Down, spawn,	         {.v = voldocmd } },  /* Volume -5% */
	{ ShiftMask,			            XK_Page_Up,	 spawn,	         {.v = volupcmd } },  /* Volume +5% */
  ...
  { MODKEY|ShiftMask,		          XK_n,		   spawn,	          {.v = nvimcmd } }, 	/* Launch nvim */
	{ MODKEY|ShiftMask,		          XK_g,		   spawn,	            {.v = bgcmd } }, 	/* Change background */
	{ MODKEY|ShiftMask,		          XK_p,		   spawn,	          {.v = ptogcmd } }, 	/* Toggle pia */
	{ MODKEY|ShiftMask,		          XK_e,		   spawn,	           {.v = emucmd } }, 	/* Launch emu */
	{ MODKEY|ShiftMask,		          XK_l,		   spawn,	          {.v = lnchcmd } }, 	/* Launch a program */
	{ MODKEY|ShiftMask,		          XK_f,		   spawn,	          {.v = forgcmd } }, 	/* Launch sd-forge */
	...
	{ ControlMask|ShiftMask,	      XK_f,		   spawn,	           {.v = pcmcmd } }, 	/* Launch pcmanfm */
	{ ControlMask|ShiftMask,	      XK_b,		   spawn,	           {.v = batcmd } }, 	/* Display device battery */
